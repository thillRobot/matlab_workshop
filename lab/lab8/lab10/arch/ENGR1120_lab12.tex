...
\end{itemize}
	...
	\item [\textbf{ \Large }] \textbf{ \Large Accessing and Assigning:}
		...
		\end{itemize}
\newpage
    \item [\textbf{ \large Assignment}] \textbf{ \Large :}\\ \\  The program below generates figure1 shown on the next page using a {\bf patch object}. Your job is to write a program to generate figures 2 3 and 4.\\\\
...
\scalebox{1}{{\fontfamily{qcr}\selectfont view(3)}}\\
		...
		\item \includegraphics[scale=.8]{lab12_fig1.png}\\
      		\item \includegraphics[scale=.8]{lab12_fig2.png}\\
      		\item \includegraphics[scale=.8]{lab12_fig3.png}\\
      		\item \includegraphics[scale=.8]{lab12_fig4.png}
	\end{description}
