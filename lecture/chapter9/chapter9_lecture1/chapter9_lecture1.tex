...
A .txt file with values delimited by commas is called a comma separared value file or {\bf .csv} file. \vspccc
...
\subsection{.mat and MATLAB}

\frame{
\frametitle{.mat and MATLAB}

{ \large {\bf .mat} files are compatible with MATLAB only}

	\begin{itemize}
	\item save() - saves the workspace to a {\bf .mat} file \vspc
	\item load() - loads a {\bf .mat} file into workspace    \vspc
	\item this is useful if you want to be stuck in MATLAB... \vspc
	\item a {\it universal} filetype is a good idea for data storage\vspace{5mm}
	\end{itemize} 

}

\subsection{Universal Filetypes}

\frame{
\frametitle{Universal Filetypes}

Standard file formats are compatible with many software systems. \vspace{5mm}\\
 	\def\arraystretch{1.25}%  
	\setlength{\tabcolsep}{1.25em} % for the horizontal padding
	\begin{tabular}{|c|c|}\hline
	Software&File Type\\\hline
	C++& .txt \\
	MATLAB & .mat .dat\\
	Python& .csv \\
	MS Excel& .xlsx \\
	ilearn & .pdf .docx\\
	Solidworks& .sldprt .stl \\ \hline
	\end{tabular}
